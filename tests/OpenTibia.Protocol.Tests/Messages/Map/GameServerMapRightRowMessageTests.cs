...
[TestFixture]
public class GameServerMapRightRowMessageTests
{
    ...
    public void Read_WithSurfaceCurrentZ_DecodesEightFloorColumns()
    {
        ...
        var message =
            (GameServerMapRightRowMessage)GameServerMapRightRowMessage.Read(GameServerOpcode.MapRightRow, reader, ItemTypes, 0);

        Assert.Multiple(() =>
        {
            Assert.That(message.Opcode, Is.EqualTo((byte)GameServerOpcode.MapRightRow));
    ...
    {
        Assert.Throws<ArgumentNullException>(() => GameServerMapRightRowMessage.Read(GameServerOpcode.MapRightRow, null!, ItemTypes, 0));
    }
    ...
    public void Read_WithNullItemTypes_Throws()
    {
        Assert.Throws<ArgumentNullException>(() =>
            GameServerMapRightRowMessage.Read(GameServerOpcode.MapRightRow, new PacketReader(new byte[2]), null!, 0));
    }
    ...
    public void Read_WithTruncatedPayload_ThrowsProtocolException()
    {
        ...
        Assert.Throws<ProtocolException>(() => GameServerMapRightRowMessage.Read(GameServerOpcode.MapRightRow, reader, ItemTypes, 0));
    }
}
