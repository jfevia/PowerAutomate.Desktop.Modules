...
public class DoubleClickControlAction : InputSimulationActionBase
{
    public DoubleClickControlAction()
    {
    }
    ...
    protected override void Run(ActionContext context)
    {
        ...
        Context.InputSender.Click(handle, Button, X ?? centerX, Y ?? centerY, true);
    }
}
