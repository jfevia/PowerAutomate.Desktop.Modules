...
/// <summary>
/// Sends a graceful logout before disconnecting, if the session was still in game.
/// </summary>
[Action(Id = "ExitGame", Category = Categories.Game)]
...
public class ExitGameAction : OpenTibiaActionBase
{
    ...
    {
        SessionGuards.RequireGame(GameSession).Client.ExitGame();
    }
}
