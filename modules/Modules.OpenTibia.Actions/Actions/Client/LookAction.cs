...
[Action(Id = "Look", Category = Categories.ClientMessages)]
...
public class LookAction : OpenTibiaActionBase
{
    ...
    protected override void Run(ActionContext context)
    {
        ...
        session.Client.Send(new ClientLookMessage(position, itemId, stackPosition));
    }
}
