...
public class GetTaskActionAction : TaskSchedulerActionBase
{
    ...
    public GetTaskActionAction()
    {
    }

    internal GetTaskActionAction(TaskSchedulerContext context) : base(context)
    {
    }
