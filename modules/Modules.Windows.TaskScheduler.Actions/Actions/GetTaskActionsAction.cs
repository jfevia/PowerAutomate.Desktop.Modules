...
public class GetTaskActionsAction : TaskSchedulerActionBase
{
    ...
    public GetTaskActionsAction()
    {
    }

    internal GetTaskActionsAction(TaskSchedulerContext context) : base(context)
    {
    }
